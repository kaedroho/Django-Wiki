...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'PageRevision.revert_reason'
        db.delete_column('wiki_pagerevision', 'revert_reason')

        # Deleting field 'PageRevision.revert_user'
        db.delete_column('wiki_pagerevision', 'revert_user_id')

        # Deleting field 'PageRevision.reverted'
        db.delete_column('wiki_pagerevision', 'reverted')


    def backwards(self, orm):
        
        # Adding field 'PageRevision.revert_reason'
        db.add_column('wiki_pagerevision', 'revert_reason', self.gf('django.db.models.fields.TextField')(default='', max_length=50, blank=True), keep_default=False)

        # Adding field 'PageRevision.revert_user'
        db.add_column('wiki_pagerevision', 'revert_user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='pagerevision_set_reverted', null=True, to=orm['auth.User'], blank=True), keep_default=False)

        # Adding field 'PageRevision.reverted'
        db.add_column('wiki_pagerevision', 'reverted', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
