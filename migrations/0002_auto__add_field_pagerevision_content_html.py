...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PageRevision.content_html'
        db.add_column('wiki_pagerevision', 'content_html', self.gf('django.db.models.fields.TextField')(default='', max_length=150000, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PageRevision.content_html'
        db.delete_column('wiki_pagerevision', 'content_html')
